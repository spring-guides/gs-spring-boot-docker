...
+ An installation of Docker. See https://docs.docker.com/installation/#installation for details about your platform

You will also need https://docker.com[Docker], which only runs on 64-bit machines. If you don't have that you are out of luck. Otherwise, see https://docs.docker.com/installation/#installation for details on setting Docker up for your machine.
