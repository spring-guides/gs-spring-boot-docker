...
NOTE: Running applications with user privileges helps to mitigate some risks. See [Can a root user inside a Docker/LXC break the security of the whole system?](https://security.stackexchange.com/questions/106860/can-a-root-user-inside-a-docker-lxc-break-the-security-of-the-whole-system).
