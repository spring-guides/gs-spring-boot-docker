...
For simply building the image locally, the following command will suffice:

----
$ ./gradlew buildImage
----

If you want to push the image to a remote repository then the following command builds the image and pushes it:
